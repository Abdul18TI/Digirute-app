<header class="main-nav">
  <div class="sidebar-user text-center">
    <a class="setting-primary"
      href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle"
  ...
  <nav>
    <div class="main-navbar">
      <div class="left-arrow"
        id="left-arrow"><i data-feather="arrow-left"></i></div>
      <div id="mainnav">
        <ul class="nav-menu custom-scrollbar">
         ...
         <li class="dropdown">
            <a class="nav-link menu-title  {{ prefixActive('rt.warga.*') ??  prefixActive('rt.kematian.*')}}"><i
                data-feather="users"></i><span>Warga</span></a>
            <ul class="nav-submenu menu-content" style="display:{{ 	request()->routeIs('rt.warga.*') ? prefixBlock('rt.warga.*') : prefixBlock('rt.kematian.*') }};">
              <li>
                <a href="{{ route('rt.warga.index') }}" class="{{ prefixActive('rt.warga.*') }}">Daftar Warga</a>
              </li>
              <li>
                <a href="{{ route('rt.kematian.index') }}" class="{{ prefixActive('rt.kematian.*') }}">Daftar Warga Meninggal</a>
              </li>
            </ul>
          </li>
          <li>
            <a class="nav-link menu-title link-nav"
              href="{{ route('rt.pengaduan.home') }}"><i data-feather="message-circle"></i><span>Pengaduan</span></a>
          </li>
          <li>
