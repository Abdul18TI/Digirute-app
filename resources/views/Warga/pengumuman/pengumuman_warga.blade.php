                        ...
                        <div class="blog-box blog-shadow">
                            ...
                            @else
                                <img class="img-fluid bg-img-cover"
                                    src="{{ asset('storage/' . $pengumuman[0]->foto_pengumuman) }}" alt="" />
                            @endif
                            <div class="blog-details">
                                ...
                                <ul class="blog-social">
                                    ...
                                    <li>Kategori: <a
                                            href="/Warga/pengumuman_warga?category={{ $pengumuman[0]->kategori_pengumuman }}">{{ $pengumuman[0]->Kategori_pengumumans->nama_kategori_pengumuman }}</a>
                                    </li>
                                </ul>
                                <hr />
                                        ...
                                        <div class="col-xl-6 col-12">
                                            <div class="blog-wrraper">
                                                @if ($k->foto_pengumuman == 'no-image.jpg')
                                                    <a
                                                        href="{{ route('warga.pengumuman_warga.show', $k->id_pengumuman) }}"><img
                                                ...
                                                @else
                                                    <a
                                                        href="{{ route('warga.pengumuman_warga.show', $k->id_pengumuman) }}"><img
                                                            class="p-0"
                                                            src="{{ asset('storage/' . $k->foto_pengumuman) }}"
                                            ...
                                            <div class="blog-details">
                                                ...
                                                <div class="blog-bottom-content">
                                                    <ul class="blog-social">
                                                        ...
                                                        @endif
                                                        <li>Kategori: <a
                                                                href="/Warga/pengumuman_warga?category={{ $k->kategori_pengumuman }}">{{ $k->Kategori_pengumumans->nama_kategori_pengumuman }}</a>
                                                        </li>
                                                    </ul>
                                                    <hr />
                            ...
                            <div class="blog-box blog-grid">
                                <div class="blog-wrraper">
                                    @if ($kk->foto_pengumuman != 'no-image.jpg')
                                        <a href="{{ route('warga.pengumuman_warga.show', $kk->id_pengumuman) }}"><img
                                                class="p-0" src="{{ asset('storage/' . $kk->foto_pengumuman) }}"
