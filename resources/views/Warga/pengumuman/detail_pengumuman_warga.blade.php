                                ...
                                <div class="blog-details">
                                    <ul class="blog-social">
                                        ...
                                        <li class="middle">Kategori :<a
                                                href="/Warga/pengumuman_warga?category={{ $pengumuman->kategori_pengumuman }}">
                                                {{ $pengumuman->Kategori_pengumumans->nama_kategori_pengumuman }}</a></li>
                                    </ul>
                                    <h4>
                                            ...
                                            <div class="single-blog-content-top txt-dark">
                                                <p class="text-center">
                                                    <img class="img-fluid w-75 "
                                                        src="{{ asset('storage/' . $pengumuman->foto_pengumuman) }}"
