                                ...
                                <div class="col">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group mt-2 m-checkbox-inline mb-0 custom-radio-ml">
                                                <div class="radio radio-primary">
                                                    <input id="1w" type="radio" name="jenis_warga" value="1" {{ old('jenis_warga',$warga->jenis_warga) == 1 ? "checked" : ""}}>
                                                    <label class="mb-0" for="1w">Tetap</label>
                                                </div>
                                                <div class="radio radio-primary">
                                                    <input id="2w" type="radio" name="jenis_warga" value="0" {{ old('jenis_warga',$warga->jenis_warga) == 0 ? "checked" : ""}}>
