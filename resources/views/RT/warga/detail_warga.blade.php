                                ...
                                <div class="profile-title">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="f-12">RW {{ $warga->identitas_rws->no_rw }} | RT {{ $warga->rt_rel->no_rt }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" disabled value="{{ $warga->jenis_kelamin == 1 ? 'Laki-laki' : 'Perempuan' }}" />
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <div class="mb-3">
