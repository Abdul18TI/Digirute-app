                ...
                <div class="col">
                  <div class="mb-3">
                    ...
                    <input class="form-control"
                      ...
                      name="nama_lengkap"
                      placeholder="Nama"
                      value="{{ $kematian->wargas->nama_lengkap }}"
                      disabled>
                  </div>
                </div>
              </div>
                ...
                <div class="col">
                  <div class="mb-3">
                    ...
                    <input class="form-control"
                      ...
                      value="{{ $kematian->wargas->pekerjaans->nama_pekerjaan }}"
                      disabled>
                  </div>
                </div>
              </div>
                ...
                <div class="col-4">
                  <div class="mb-3">
                    ...
                    <input class="form-control"
                      ...
                      value="{{ $kematian->wargas->tempat_lahir }}"
                      disabled>
                  </div>
                </div>
                <div class="col">
                  <div class="mb-3">
                    ...
                    <input class="form-control"
                      ...
                      value="{{ tanggal_indo($kematian->wargas->tgl_lahir) }}"
                      disabled>
                  </div>
                </div>
              </div>
                ...
                <div class="col">
                  <div class="mb-5">
                    ...
                    <textarea name="alamat"
                      ...
                      id="alamat"
                      placeholder="Alamat"
                      disabled>{{ $kematian->wargas->alamat }}</textarea>
                  </div>
                </div>
              </div>
                ...
                <div class="col">
                  <div class="mb-3">
                    ...
                    <input class="form-control"
                      ...
                      id="tgl_kematian"
                      name="tgl_kematian"
                      value="{{ tanggal_indo($kematian->tgl_kematian) }}"
                ...
                <div class="col">
                  <div class="mb-3">
                    ...
                    <input class="form-control"
                      ...
                      name="tgl_lahir_pelapor"
                      placeholder="Tanggal Lahir"
                      value="{{ tanggal_indo($kematian->tgl_lahir_pelapor) }}"
                      disabled>
                  </div>
                </div>
              </div>
