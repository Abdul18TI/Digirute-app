                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="bookmark">
                                    ...
                                    <a class="btn btn-primary btn-lg" href="{{ route('rt.kemiskinan.create') }}"
                                ...
                                <tbody>
                                    @foreach ($kemiskinan as $p)
                                        <tr>
                                            ...
                                            <td class="aksi">
                                                <a class="btn btn-info btn-sm p-2" href="{{ route('rt.kemiskinan.show', $p->id) }}">
                                                    <span class="fa fa-eye"></span>
                                                </a>
                                                <form method="POST"
                                                    action="{{ route('rt.kemiskinan.destroy', $p->id) }}"
                                                    class="d-inline">
                                                    @csrf
