                    ...
                    <form class="form theme-form" method="POST" enctype="multipart/form-data" action="{{ route('rw.kegiatan.store')}}">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleFormControlInput1">Nama
                                            kegiatan</label>
                                        <input class="form-control @error('nama_kegiatan') is-invalid @enderror" name="nama_kegiatan" id="exampleFormControlInput1" type="text" autofocus value="{{ old('nama_kegiatan') }}"/>
                                        @error('nama_kegiatan')
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input id="isi_kegiatan" type="hidden" value="{{ old('isi_kegiatan') }}" name="isi_kegiatan">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control digits" id="example-datetime-local-input"
                                        type="datetime-local" name="tgl_mulai_kegiatan" value="{{ old('tgl_mulai_kegiatan') }}" />
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control digits" id="example-datetime-local-input"
                                        type="datetime-local" name="tgl_selesai_kegiatan" value="{{ old('tgl_selesai_kegiatan') }}" />
                                </div>
