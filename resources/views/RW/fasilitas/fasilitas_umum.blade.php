		...
		<div class="feature-products">
			<div class="row">
				...
				<div class="col-md-3">
                    ...
                    href="{{ route('rw.fasilitasrw.create') }}"
	            ...
	            <div class="card">
	                <div class="blog-box blog-grid">
	                    <div class="blog-wrraper">
	                        <a href="{{ route('rw.fasilitasrw.show',$kk->id_fasilitas_umum) }}"><img class="p-0" src="{{ asset('storage/' . $kk->foto_fasilitas) }}" width="421" height="263" alt="" /></a>
	                    </div>
	                    <div class="blog-details-second">
	                        ...
	                        <div class="detail-footer">
	                            <ul class="sociyal-list">
	                                <li><i class="fa fa-building-o"></i><a href="/RW/fasilitasrw?category={{ $kk->kategori_fasilitas_umum }}">{{ $kk->fasilitas_umumss->kategori_fasilitas }}</a></li>
	                            </ul>
	                        </div>
	                    </div>
	                </div>
